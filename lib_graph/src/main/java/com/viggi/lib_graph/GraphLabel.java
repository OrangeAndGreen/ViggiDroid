...
public class GraphLabel implements IGraphElement
{
    ...
    public GraphLabel(boolean title, float fontSize)
    {
        this(null);
        mTitle = title;
        mFontSize = fontSize;
    ...
    public GraphLabel(Point location, String text, float fontSize)
    {
        this(location);
        mFontSize = fontSize;
        Text = text;
    ...
    //public GraphLabel(Point location, String text, Paint.Align hAlign, VerticalAlign vAlign)
    //{
    //    this(location, text);
    //    HAlign = hAlign;
    //    VAlign = vAlign;
